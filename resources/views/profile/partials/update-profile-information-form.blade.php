<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="documento" name="documento" type="number" class="mt-1 block w-full" :value="old('documento', $user->documento)" required autofocus autocomplete="documento" />
