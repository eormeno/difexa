<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Editar publicación', ['publicacion' => $publicacion->titulo]) }}
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('publicaciones.update', $publicacion) }}" novalidate>
                        ...
                        <div>
                            ...
                            <x-text-input id="titulo" class="block mt-1 w-full" type="text" name="titulo"
                                :value="old('titulo', $publicacion->titulo)" required autofocus autocomplete="titulo" />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="contenido" rows="2" cols="50" class="block mt-1 w-full dark" style="background-color: rgb(17 24 39 / var(--tw-bg-opacity)); color: white;" type="text" name="contenido"
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="desde" class="block mt-1 w-full" type="date" name="desde"
                                :value="old('desde', $publicacion->desde)" required autofocus autocomplete="desde" />
