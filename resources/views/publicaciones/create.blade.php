     ...
     <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
       <div class="p-6 text-gray-900 dark:text-gray-100">
        <form method="POST" action="{{ route('publicaciones.store') }}" enctype="multipart/form-data" novalidate>
         @csrf

         <!-- Título -->
         <div>
          <x-input-label for="titulo" :value="__('Título')" />
          <x-text-input id="titulo" class="block mt-1 w-full" :value="old('titulo')" type="text" name="titulo" required autofocus autocomplete="titulo" />
         ...
         <div class="mt-4">
          ...
          <x-text-input id="contenido" class="block mt-1 w-full" type="text" :value="old('contenido')" name="contenido" required autofocus autocomplete="contenido" />
