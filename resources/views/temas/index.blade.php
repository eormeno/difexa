                    ...
                    <div>
                        <div class="grid grid-cols-4 gap-5">
                            @forelse ($temas as $tema)
                                <div class="rounded-xl bg-gray-300 shadow p-2">
                                    <div class="group relative">
                                        ...
                                        <button class="hidden group-hover:block cursor-pointer
                                            ...
                                            x-data=""
                                            x-on:click.prevent="$dispatch('open-modal', 'confirm-tema-deletion-{{$tema->id}}')">
                                ...
                                <x-modal name="confirm-tema-deletion-{{$tema->id}}"
                                    :show="$errors->userDeletion->isNotEmpty()" focusable>
                                       <form method="post"
                                       action="{{ route('temas.destroy', $tema) }}" class="p-6">
                                          @csrf
                                          @method('delete')
