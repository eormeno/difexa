                            ...
                            @forelse ($temas as $tema)
                                <div class="rounded-xl bg-gray-300 shadow p-2">
                                    <div class="group relative">
                                        ...
                                        <button
                                            class="hidden group-hover:block cursor-pointer absolute top-0 right-0 p-2 text-red-400 hover:text-red-600" x-data="" x-on:click.prevent="$dispatch('open-modal', 'confirm-dispositivo-deletion-{{ $tema->id }}')">
                                ...
                                <x-modal name="confirm-dispositivo-deletion-{{ $tema->id }}" :show="$errors->userDeletion->isNotEmpty()"
                                    focusable>
                                    <form method="post" action="{{ route('temas.destroy', $tema) }}"
                                        ...
                                        <h1 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                                            ...
                                            <span class="font-extrabold"> <span class="text-red-400">"{{ $tema->titulo }}"<span></span>
                                        </h1>
