...
Route::middleware(['auth', 'es_admininstrador'])->group(function() {
    ...
    Route::get('/tema/{tema}', [TemasController::class, 'show'])->name('tema.show');
    Route::post('/tema', [TemasController::class, 'store'])->name('tema.store');
    Route::get('/tema/{tema}/edit', [TemasController::class, 'edit'])->name('tema.edit');
    Route::patch('/tema/{tema}', [TemasController::class, 'update'])->name('tema.update');
    ...
    Route::get('/dispositivo/{dispositivo}/{action?}/{tema?}', [DispositivoController::class, 'edit'])->name('dispositivo.edit');
